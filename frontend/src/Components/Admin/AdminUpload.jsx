          ...
          >
            ...
            <div className="w-full">
              ...
              <input
                ...
                value={batch}
                className="bg-gray-50 border border-gray-300 outline-none text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 uppercase"
