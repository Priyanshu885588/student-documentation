  ...
  return (
    ...
    <div className=" bg-white min-h-screen justify-center items-center">
      ...
      <div className="bg-yellow-300 text-white py-4 text-center my-5  max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-LEFT text-black mx-10">File upload</h1>
      </div>
...
<div className="w-2/3 bg-gray-200 rounded-full h-2.5  dark:bg-gray-700">
  ...
  <button type="submit"  className="  mt-7 mb-10 ml-56 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm w-24  px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
